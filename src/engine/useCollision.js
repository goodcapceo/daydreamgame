...
export const useCollision = () => {
   ...
   */
  const checkAABB = useCallback((rect1, rect2) => {
    return (
   ...
   */
  const circleRectCollision = useCallback((circle, rect) => {
   ...
   */
  const checkGridCollision = useCallback((gridX, gridY, grid) => {
   ...
   */
  const checkPlatformCollision = useCallback((player, platform, previousY) => {
   ...
   */
  const getEntitiesInRadius = useCallback((center, entities, radius) => {
